...
let
  ...
  yazi = tomlFmt.generate "yazi" config.yazi;
  keymap = tomlFmt.generate "keymap" config.keymap;
  theme = tomlFmt.generate "theme" config.theme;
  vfs = tomlFmt.generate "vfs" config.vfs;
in
{
